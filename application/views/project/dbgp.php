			...
			<nav class="navbar navbar-default sidebar" role="navigation">
			    ...
			    <div class="collapse navbar-collapse" id="bs-sidebar-navbar-collapse-1">
			      <ul class="nav navbar-nav proj_nav">
			      	<li class=""><a href="{base_url}project?id=<?=$_GET['id']?>">Overview<span style="font-size:16px;" class="pull-right hidden-xs showopacity glyphicon glyphicon-home"></span></a></li>
			        <li class="dropdown active open">
			          ...
			          <ul class="dropdown-menu forAnimate" role="menu">
			            ...
			            <li class="active"><a href="{base_url}project/dbgp?id=<?=$_GET['id']?>">Google plus</a></li>
			          </ul>
			        </li>
		...
		<div class="col-lg-9 col-md-8 col-sm-6 col-xs-6">		
			<div class="panel panel-default">	
				<div class="filter_container">	
					...
					<a class="export_excel" download="firebase_gp_<?=strtolower(str_replace(' ','_',$project_name))?>.xls" href="#" onclick="return ExcellentExport.excel(this, 'datatable', 'Test');">Export to Excel</a>
				</div>
...
function generate_data(month_ini, month_end) {
	var userDataRef = database.ref("gp").startAt(month_ini).endAt(month_end).orderByChild('date');
	userDataRef.on("value", function(snapshot) {
		...
		html +="<tr>";
		html += "<td>" + counter + "</td>";
		html += "<td style='text-overflow: ellipsis;'>" + childData.name + "</td>";
